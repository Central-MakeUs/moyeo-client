...
describe('buildPastCellKeys', () => {
  ...
  it('모든 열이 serverToday 이후면 오늘 열의 지난 시간대까지 열어둔 채 빈 집합을 반환한다', () => {
    expect(buildPastCellKeys(['2026-07-10', '2026-07-11'], ROWS, '2026-07-10').size).toBe(0);
  });
});
