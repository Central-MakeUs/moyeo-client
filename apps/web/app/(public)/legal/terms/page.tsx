    ...
    <div className="flex h-dvh w-full flex-col bg-white">
      ...
      <main className="min-h-0 flex-1 overflow-y-auto px-5 py-6">
        <article className="flex flex-col pb-10 break-keep text-neutral-600">
          <p className="mb-8 text-medium-12 text-neutral-500">최종 수정 일자: 2026.08.06</p>

          <div className="flex flex-col gap-8">
            <PolicySection label="제1조" title="(목적)">
            ...
            <PolicySection label="제2조" title="(서비스의 내용)">
            ...
            <PolicySection label="제3조" title="(이용 자격 및 계정)">
              <ul className="flex list-disc flex-col gap-2 pl-4 text-medium-14 marker:text-neutral-300">
            ...
            <PolicySection label="제4조" title="(이용자의 의무)">
              <ul className="flex list-disc flex-col gap-2 pl-4 text-medium-14 marker:text-neutral-300">
            ...
            <PolicySection label="제5조" title="(게시물 및 콘텐츠)">
              <p className="text-medium-14">
            ...
            <PolicySection label="제6조" title="(초대 링크)">
              <p className="text-medium-14">
            ...
            <PolicySection label="제7조" title="(면책 조항)">
              <ul className="flex list-disc flex-col gap-2 pl-4 text-medium-14 marker:text-neutral-300">
                <li>
            ...
            <PolicySection label="제8조" title="(서비스의 변경 및 중단)">
              <p className="text-medium-14">
            ...
            <PolicySection label="제9조" title="(이용 계약의 해지)">
              <p className="text-medium-14">
            ...
            <PolicySection label="제10조" title="(약관의 변경)">
              <p className="text-medium-14">
                약관이 변경될 경우 서비스 내 공지를 통해 안내하며, 변경 후에도 서비스를 계속
                이용하면 변경된 약관에 동의한 것으로 간주합니다.
              </p>
            </PolicySection>

            <PolicySection label="제11조" title="(문의)">
              <ul className="flex list-disc flex-col gap-2 pl-4 text-medium-14 marker:text-neutral-300">
                <li>서비스명: 모여(MOYEO)</li>
