        ...
        <article className="flex flex-col pb-10 text-neutral-700">
          ...
          <section className="mt-8 flex flex-col gap-3">
            ...
            <p className="text-medium-14">
              모임 커버사진은 사진 라이브러리 접근 권한을 통해 선택된 파일만 수집하며, 해당 모임의
              참여자에게만 표시됩니다. 사진 라이브러리 접근 권한은 커버사진 등록 시에만 요청되며,
              권한을 허용하지 않아도 기본 이미지로 모임을 생성할 수 있습니다.
            </p>
          </section>
